...
class MapReduce(object):
    """
        map_func
          Function to map inputs to intermediate shakespeare. Takes as
          argument one input value and returns a tuple with the key
          and a value to be reduced.
        reduce_func
          Function to reduce partitioned version of intermediate shakespeare
    ...
    Process the inputs through the map and reduce functions given.
        ...
        inputs
          An iterable containing the input shakespeare to be processed.
        
        chunksize=1
          The portion of the input shakespeare to hand to each worker.  This
